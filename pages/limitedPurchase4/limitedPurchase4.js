...
Page({
    ...
    change(e) {
        ...
        //     util.errorTips(`单次限购${peopleLimit}卷`)
        //     this.setData({
    ...
    updataInfo(cb) {
        ...
        api.activity({
            ...
            // 兼容苹果时间格式
            itemInfo.isActiveEnd = (Date.parse(itemInfo.now_date.replace(/-/g, '/')) - Date.parse(itemInfo.end_date.replace(/-/g, '/')) > 0) || itemInfo.last_stock <= 4;
